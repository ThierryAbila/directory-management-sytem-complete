...
if(isset($_POST['submit'])){
    ...
    $sql="insert into `private` (name,email,mobile,address,city,zip) values('$name','$email','$mobile','$address','$city','$zip')";
...
<!-- sidebar -->
    <div class="container my-5">
        <form class="row g-3" method="post">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary" name="submit">make private</button>
            </div>
        </form>
    </div>
    <!-- scrid code for the toggle slide -->
    <script>
function openNav() {
