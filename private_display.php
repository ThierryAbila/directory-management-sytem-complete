         ...
         <table class="table">
            ...
            <tbody>
              ...
              while( $row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$zip.'</td>
                  <td>
                  <button class="btn btn-primary"><a href="private_update.php? updateid='.$id.'"class="text-light">update</a></button>
                  <button class="btn btn-danger"><a href="private_delete.php? deleteid='.$id.'"class="text-light">Delete</a></button>
                  </td>
                </tr>';
              }
              }
